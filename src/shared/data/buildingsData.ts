...
export const buildings: Building[] = [
  ...
  },
  {
    ...
    area: 5380,
    floors: 1,
    polygon: "81.1,41.7 77.1,41.9 76.9,42.1 68.5,42.6 68.6,46.2 64.6,46.7 65.5,69.5 70.8,69.8 71.7,81 71.7,81.8 85,80.7 85.8,80.1 84.2,68.4 84,68.2 81.4,46.2 81.6,45.9",
    mx: 75,
    my: 52,
  },
  {
